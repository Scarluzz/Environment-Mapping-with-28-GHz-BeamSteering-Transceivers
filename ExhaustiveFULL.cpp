...
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    double          Nr_Of_Tx_beams      = 31;
    double          Nr_Of_Rx_beams      = 31;
    ...
    OutFilename = Exp_Name + "ExhaustiveFULL.dat";
    ...
    //("OutFile", po::value<std::string>(&OutFilename)->default_value("ExhaustiveFULL.dat"), "name of the output file")
    ("InputFile", po::value<std::string>(&InFilename)->default_value("QPSK.dat"), "name of the input file containing the TX samples")   
